...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:laverandadasimona@gmail.com?subject=${encodeURIComponent(formData.subject)}&body=${encodeURIComponent(`Nome: ${formData.name}\nEmail: ${formData.email}\n\nMessaggio:\n${formData.message}`)}`;
            ...
            <div className="bg-white p-10 rounded-3xl shadow-xl border border-stone-100">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-4">
                  ...
                  <button type="submit" className="w-full md:w-auto bg-primary text-white px-12 py-4 rounded-xl font-bold flex items-center justify-center gap-3 shadow-xl shadow-primary/20 hover:scale-105 transition-all active:scale-95">
                    {t.contact.sendBtn}
